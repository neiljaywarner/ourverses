    ...
    body: PageView(
      ...
      controller:  _controller,
          ...
          children: verses.map((e) =>
              Card(
                child: Center(child: ListTile(title: Text(e.reference,textScaleFactor: 1.7,),
...
// TODO: use https://bible-api.com/romans+12:1-2
class DisplayVerse {
...
that I might not sin against you.'''),
  DisplayVerse('Col 1:17 WEB ', 'He is before all things, and in him all things are held together.'),
  DisplayVerse('Psalms 62:7 WEB', '''My salvation and my honor is with God.
